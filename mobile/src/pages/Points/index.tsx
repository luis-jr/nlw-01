...
import { View, Alert, Image, ScrollView, Text, StyleSheet, TouchableOpacity } from 'react-native';
...
const Points = () => {
  ...
  useEffect(() => {
    async function loadPosition() {
      ...
      if (status !== 'granted'){
        Alert.alert('Oooops...', 'Precisamos da sua permissão para obter a sua localização!');
        return;
      }
    ...
    <>
      <View style={styles.container}>
        ...
        <Text style={styles.title}>
          <Emoji name="relaxed" style={{fontSize: 20}} />
            Bem vindo.
        </Text>
